...
export default function Index() {
	return (
		<>
			<div className="m-auto flex flex-1 flex-col items-center justify-center overflow-visible px-8 md:max-w-2xl lg:max-w-3xl">
				<figure className="flex max-h-fit flex-1 flex-col justify-center overflow-visible pb-4">
					<img
						className="animate-hue-backdrop scale-down h-auto w-screen object-center"
					...
					/>
					<figcaption className="relative text-lg opacity-85">
